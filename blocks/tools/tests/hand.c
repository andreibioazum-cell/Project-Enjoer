...
void geometrium3d_polygon(const GeometriumVertex *v,int n,float nx,float ny,float nz,uint32_t color,GeometriumMaterial *material,const unsigned char light[4]) {
