...
WORLD="rbx/rbx_world.c rbx/rbx_light.c rbx/rbx_water.c rbx/rbx_terrain.c rbx/rbx_mesh.c rbx/rbx_edits.c"
...
"$DIR/render"
$CC $FLAGS $CORE rbx/rbx_hand.c tools/tests/hand.c -lm -o "$DIR/hand"
"$DIR/hand"
