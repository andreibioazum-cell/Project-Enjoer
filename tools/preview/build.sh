...
${CC:-gcc} -O2 -std=c99 -Itools/preview/compat -I. \
    ...
    rbx/rbx_terrain.c rbx/rbx_world.c rbx/rbx_light.c rbx/rbx_water.c rbx/rbx_mesh.c rbx/rbx_edits.c \
    rbx/rbx_interact.c rbx/rbx_perf.c rbx/rbx_player.c rbx/rbx_input.c \
    rbx/rbx_scene.c rbx/rbx_hud.c rbx/rbx_hand.c rbx/rbx_game.c \
