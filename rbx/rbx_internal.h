...
#define RBX_FOG_START 40.0f
#define RBX_FOG_END 80.0f
#define RBX_FAR_Z 96.0f
...
void rbx3d_surface(int sx,int sy,int sz,int u,int v,int face,int block,const unsigned char light[4]);
...
void rbx_hand_swing(void);
void rbx_hand_equip(void);
